...
namespace Shmembee.WpdSidecar
{
    internal sealed class WpdDiagnosticJournal
    {
        ...
        public WpdDiagnosticJournal(string path, string activityId, string operationId)
        {
            this.path = path;
        ...
        public void Write(string kind, IDictionary<string, string> data = null)
        {
            try
            {
                Rotate();
            ...
            {
                // The protocol and WPD operation must survive diagnostic failures.
            }
        }
